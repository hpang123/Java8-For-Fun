...
public class ParallelOperationDemo extends Application {
	public static void main(String[] args) {
		launch(args);
	}

	public static Color[][] parallelTransform(Color[][] in,
	...
	public void start(Stage stage) {
		Image image = new Image("file:./src/ch3/eiffel-tower.jpg");
